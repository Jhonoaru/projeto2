document.getElementById("formulario").addEventListener('submit', function(event){
    ...
    document.getElementById('excluir-todos').addEventListener('click', excluirTodosUsuarios);
...
document.getElementById('mostrar-usuario').addEventListener('click', function() {
    ...
    if(listaUsuariosDiv.style.display === 'none' || listaUsuariosDiv.style.display === ''){
...
document.getElementById('mostrar-pesquisa').addEventListener('click', function() {
    const campoPesquisa = document.getElementById('campo-pesquisa');
    if(campoPesquisa.style.display === 'none' || campoPesquisa.style.display === ''){
...
document.getElementById('botao-pesquisar').addEventListener('click', function() {
    ...
    const usuarios = JSON.parse(localStorage.getItem('usuarios')) || [];
    const usuarioEncontrado = usuarios.find(usuario => usuario.email.toLowerCase().includes(pesquisa) || usuario.id.toString().includes(pesquisa));

    const resultadoPesquisa = document.getElementById('resultado-pesquisa');
    const usuarioEncontradoElemento = document.getElementById('usuario-encontrado');
